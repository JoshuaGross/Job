...
module.exports.startJobsRunner = function (_options) {
  ...
  serverswap.readyFor('Job:kue', function () {
    ...
    httpServer.listen(options.kue.port);
    ...
    serverswap.onTakedown('Job:kue', function () {
      httpServer.close();
      setTimeout(function () {
        process.exit(0);
      }, 1000);
    ...
    for (var methodName in helper.exports) {
      ...
      if (typeof method === 'function' && (!!method.delayable) === true) {
        ...
        (function (method, methodName) {
          ...
          }, options.startupDelay || 0); // don't start processing delayed jobs for X ms, to give the rest of the app time to boot up (optional)
        })(method, methodName);
      }
    }
  });
