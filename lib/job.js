...
module.exports.addHelper = function (helper) {
  return process.nextTick(function () {
    ...
    console.time('addHelper '+helper.filename);
    ...
    for (var methodName in helper.exports) {
      ...
      if (typeof method === 'function' && (!!method.delayable) === true) {
        ...
        (function (method, methodName) {
          ...
          console.time('addHelper Spawn '+helper.filename);
          spawnRunner(jobName, methodName, function (runner) {
            console.timeEnd('addHelper Spawn '+helper.filename);
            console.timeEnd('addHelper '+helper.filename);
